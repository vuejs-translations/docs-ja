...
また、このパラダイムの上に構築され、SSR のビルトインサポートを備えたより高レベルの[Vue フレームワーク](/guide/quick-start#frameworks)もあり、フルスタックアプリケーションを開発することが可能です。
...
Vue チームは、[VitePress](https://vitepress.dev/) と呼ばれる静的サイトジェネレータをメンテナンスしており、今あなたが読んでいるこの Web サイトを動かしていて、SSG の両方の種類をサポートしています！　加えて、通常 SSG をサポートしているその他の[Vue フレームワーク](/guide/quick-start#frameworks)もぜひチェックしてみてください。
